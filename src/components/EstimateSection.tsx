...
const EstimateSection: React.FC = () => {
  return (
    <div className="w-full max-w-[1200px] mx-auto my-[30px] lg:my-[100px] px-4 md:px-0 relative z-20">
      {/* Mobile View */}
      <div className="md:hidden relative h-[380px] w-full max-w-[360px] mx-auto rounded-tr-[100px] overflow-hidden shadow-2xl mt-2">
        <img
          loading="lazy"
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 flex flex-col justify-end">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              <p className="text-[18px] font-semibold">+91 96232 33175</p>
      ...
      <div className="hidden md:block relative h-[650px] w-full rounded-tr-[200px] overflow-hidden shadow-2xl group">
        ...
        />
        <div className="absolute top-50 left-[80px] z-10 max-w-[600px]">
          ...
          <div className="flex gap-6 items-center">
            ...
            <div className="text-white drop-shadow-md">
              <p className="text-[26px] font-bold tracking-wide">+91 96232 33175</p>
              <p className="text-[18px] font-medium uppercase tracking-wider opacity-90">
                Call Us Anytime
              </p>
            </div>
          </div>
          <p className="text-[22px] leading-[34px] font-medium text-white drop-shadow-md mb-4 mt-6">
